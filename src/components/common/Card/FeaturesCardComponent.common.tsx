...
import ButtonComponent from '../ButtonComponent.common';
            ...
            <div className="sanerNowCardContentsSection">
                ...
                <div className={id === 4 ? 'card2SubContents' : 'subContents'}>
                    {subHeading.map((ele, i) => {
                        return (
                            <div key={i} className={'sub-headings'} style={subheadingStyle}>
                    ...
                    {features.map((ele, i) => {
                        return (
                            <div className={'contents'} key={i}>
                                <div className={isHovered ? 'circlehover' : 'circle-with-tick'}></div>
