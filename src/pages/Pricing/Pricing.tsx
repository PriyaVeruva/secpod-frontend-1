...
function Pricing(): JSX.Element {
    return (
        <div className={styles.pricingContainer}>
            <h2 className={styles.pricingHeaderContent}>{text.landingPage.HEADER_CONTENT_3}</h2>
            <p className={styles.paragraphContent}>{text.landingPage.PARAGRAPH_CONTENT_3}</p>
