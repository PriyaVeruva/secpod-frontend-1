    ...
    return (
        <div className={styles.toolsContainer}>
            ...
            <div className={styles.featuresContentSection}>
                <h2 className={styles.titleContent}>{text.landingPage.SECURITY_AND_IT_HEADER_CONTENT} </h2>
                <p className={styles.titleSubContent}>{text.landingPage.SECURITY_AND_IT_SUB_CONTENT}</p>
            </div>
